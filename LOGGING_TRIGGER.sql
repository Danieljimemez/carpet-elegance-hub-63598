-- Crear tabla de logs para debugging
...
-- Trigger que registra en tabla de logs
        ...
        BEGIN
            CASE target_table
                ...
                WHEN 'gallery_photos' THEN
                    ...
                    VALUES (product_name, 'Foto galería ' || product_name, public_url, true);
            END CASE;
...
-- Hacer la tabla de logs visible
ALTER TABLE public.trigger_logs ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Allow read access to logs" ON public.trigger_logs FOR SELECT USING (true);
